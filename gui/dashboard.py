...
class DashboardFrame(ctk.CTkFrame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        # Tarjeta 3: Ángulo del Hombro
        self.card_hombro = ctk.CTkFrame(self, fg_color="#222222", corner_radius=8)
        self.card_hombro.grid(row=0, column=2, padx=10, pady=10, sticky="nsew")
        
        lbl_t3 = ctk.CTkLabel(self.card_hombro, text="ÁNGULO HOMBRO", font=ctk.CTkFont(size=10, weight="bold"), text_color="gray")
        ...
        # Tarjeta 4: Lado Detectado
        self.card_lado = ctk.CTkFrame(self, fg_color="#222222", corner_radius=8)
        self.card_lado.grid(row=0, column=3, padx=10, pady=10, sticky="nsew")
        
        lbl_t4 = ctk.CTkLabel(self.card_lado, text="LADO LEÍDO", font=ctk.CTkFont(size=10, weight="bold"), text_color="gray")
    ...
    def actualizar_metricas(self, angulo_tronco, angulo_cuello, angulo_hombro, lado, t_tronco, t_cuello, t_hombro):
