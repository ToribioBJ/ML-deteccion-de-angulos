...
def registrar_posturas_excel(
    ...
    """
    Registra datos de postura en un archivo Excel con 3 hojas independientes.
    ...
    # Asegurar que existan las tres hojas requeridas
    sheets = {}
    ...
    # Eliminar hojas antiguas o por defecto que no sean las tres oficiales
